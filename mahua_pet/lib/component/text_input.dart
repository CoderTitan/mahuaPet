...
class TextInput extends StatefulWidget {
  ...
  _TextInputState createState() =>
      _TextInputState(showObscure: showObscure, cleanType: cleanType);
}
...
class _TextInputState extends State<TextInput> {
  ...
  _TextInputState({required this.showObscure, required this.cleanType})
      : _securityText = showObscure,
        _showClean = cleanType == TextCleanType.always;
  ...
  Widget? getSuffixWidget() {
    ...
    if (_showClean || widget.showObscure) {
      return Container(
        width: 60.px,
        child: Row(
            mainAxisAlignment: MainAxisAlignment.end, children: getListIcon()),
      );
    }
    return null;
  }
  ...
  List<Widget> getListIcon() {
    ...
    if (_showClean) {
      SizedBox cleanIcon = SizedBox(
          ...
          child: IconButton(
              ...
              icon: Image.asset('${TKImages.image_path}login_clean.png',
                  width: 14.px, height: 14.px, fit: BoxFit.contain),
              onPressed: () {
    ...
    if (widget.showObscure) {
      String eyeImg = !_securityText
          ? '${TKImages.image_path}login_eye.png'
          : '${TKImages.image_path}login_eye_un.png';
      SizedBox cleanIcon = SizedBox(
          width: 30.px,
          height: 24.px,
          child: IconButton(
              ...
              icon: Image.asset(eyeImg,
                  width: 16.px, height: 16.px, fit: BoxFit.contain),
              onPressed: () {
                setState(() {
